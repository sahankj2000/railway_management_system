...
public class MySQL {
    ...
    static String mysqlURL="jdbc:mysql://localhost:3307/Railway";
    ...
    public ObservableList getUsers() throws SQLException {
        ...
        rs=pst.executeQuery();
        ObservableList<backend.user> people= FXCollections.observableArrayList();
        while (rs.next()){
    ...
    public ObservableList getTrains() throws SQLException {
        ...
        rs=pst.executeQuery();
        ObservableList<backend.train> trains=FXCollections.observableArrayList();
        while(rs.next()){
    ...
    public ObservableList getStations() throws SQLException {
        ...
        rs=pst.executeQuery();
        ObservableList<backend.station> stations=FXCollections.observableArrayList();
        while (rs.next()){
    ...
    public ObservableList getRoutes() throws SQLException {
        ...
        rs=pst.executeQuery();
        ObservableList<backend.route> routes=FXCollections.observableArrayList();
        while (rs.next()){
    ...
    public ObservableList getTicket() throws SQLException {
        ...
        rs=pst.executeQuery();
        ObservableList<backend.ticket> tickets=FXCollections.observableArrayList();
        while (rs.next()){
